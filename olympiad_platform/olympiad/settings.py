...
ALLOWED_HOSTS = ['olympiad-platform.onrender.com', 'http://0.0.0.0:10000']
...
DATABASES = {
    'default': dj_database_url.config(default='postgres://kseniia:@localhost:5432/olympiad_platform')
    }
